    ...
    <main className="flex flex-col min-h-screen bg-gray-100 p-4 sm:p-24">
      <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <section>
          ...
          <p className="text-gray-700">
            If you have any questions or concerns about these terms and conditions, please contact us at <a href="mailto:support@smilingrobo.com" className="text-blue-600 hover:underline">Email Us</a>.
          </p>
        </section>
      </div>
    </main>
